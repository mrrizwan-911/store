...
export function FloatingWhatsApp() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 w-14 h-14 bg-[#25D366] text-white shadow-xl hover:scale-105 transition-transform flex items-center justify-center group overflow-hidden rounded-md z-50"
